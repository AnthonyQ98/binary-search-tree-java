public class BinarySearchTree<T> {
    ...
    //locates and returns the largest value stored in the tree
    ...
    //locates and returns the smallest value stored in the tree
    //as defined by it location in the tree
    public T findMin() {
        if(isEmpty()){
            throw new RuntimeException();
    ...
    public T findMin(BTNode<T> current){
        //base case
        if(current.left ==null){
            return current.element;
        } else {
    ...
    public BTNode<T> findParent(T element, BTNode<T> current) {
        // special case
    ...
    public static void main (String[] args){
        ...
        System.out.println("------------------");
        System.out.println("Size of the Binary Search Tree: "+ numbers.size());

        System.out.println("------------------");
        System.out.println("Max element of Binary Search Tree: "+ numbers.findMax());

        System.out.println("------------------");
        System.out.println("Min element of Binary Search Tree: "+ numbers.findMin());

        System.out.println("------------------");
        numbers.remove(4);
        System.out.println("4 elements removed!");
